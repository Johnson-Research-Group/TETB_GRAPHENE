...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(airebo/sigma,PairAIREBOSigma);
// clang-format on
#else

#ifndef LMP_PAIR_AIREBO_SIGMA_H
#define LMP_PAIR_AIREBO_SIGMA_H
...
class PairAIREBOSigma : public Pair {
 public:
  PairAIREBOSigma(class LAMMPS *);
  ~PairAIREBOSigma() override;
